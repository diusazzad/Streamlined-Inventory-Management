                ...
                <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="{{ url('orders.complete') }}">
                                        {{ __('Completed') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('orders.pending') }}">
                                        {{ __('Pending') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('due.index') }}">
                                        {{ __('Due') }}
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown {{ request()->is('purchases*') ? 'active' : null }}">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="{{ url('purchases.index') }}">
                                        {{ __('All') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('purchases.approvedPurchases') }}">
                                        {{ __('Approval') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('purchases.dailyPurchaseReport') }}">
                    ...
                    <li class="nav-item {{ request()->is('quotations') ? 'active' : null }}">
                        <a class="nav-link" href="{{ url('quotations.index') }}">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    ...
                    <li class="nav-item dropdown {{ request()->is('suppliers*', 'customers*') ? 'active' : null }}">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="{{ url('suppliers.index') }}">
                                        {{ __('Suppliers') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('customers.index') }}">
                                        {{ __('Customers') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="{{ url('categories.index') }}">
                                        {{ __('Categories') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ url('units.index') }}">
                                        {{ __('Units') }}
                                    </a>
                                </div>
                            </div>
